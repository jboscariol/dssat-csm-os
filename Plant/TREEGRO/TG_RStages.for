...
C-GH  IF (CONTROL%RUN .EQ. 1 .OR. INDEX('P',CONTROL%RNMODE).LE. 0) THEN ! JZW add this for debug
...
! Print the day of the year when flowering starts
!                PRINT*, ' Flowering: ', YRNR1
              ENDIF
            ENDIF
          ENDIF
        ENDIF
...
! Print the day of the year when flowering starts
!          PRINT*, 'Flowering started on: ', YRNR1
        ENDIF
      ENDIF
C-------------------------------------------------------------------------------
